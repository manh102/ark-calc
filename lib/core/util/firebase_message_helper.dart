...
import 'package:new_ark_calc/core/util/logger_util.dart';

import '../secure_storage/share_preferences.dart';
...
class FirebaseMessageHelper {
  ...
  Future<void> refreshToken() async {
    FirebaseMessaging.instance.onTokenRefresh.listen((newToken) async {
      ...
      await BaseStorage.instance.prefs.setString('tokenPushId', newToken);
    });
  }
  ...
  Future getFcmToken() async {
    return FirebaseMessaging.instance.getToken().then((token) async {
      ...
      await BaseStorage.instance.prefs.setString('tokenPushId', token ?? '');
    });
  }
